...
- Do not commit API keys, database credentials, local environment files, or system files.
- Add screenshots and live demo links as the main projects become more polished.
